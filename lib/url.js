...
const { urlPlaceholders } = require('./placeholders');

// This class mimicks https://github.com/jekyll/jekyll/blob/cc82d442223bdaee36a2aceada64008a0106d82b/lib/jekyll/url.rb
...
const generateUrl = function (template, jekyllResource) {
  ...
  return new JekyllUrl(template, placeholders).toString();
};
